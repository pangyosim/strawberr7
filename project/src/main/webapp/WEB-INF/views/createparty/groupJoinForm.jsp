...
<!-- 이름 / 연락처 / 주민번호 / 출금계좌  -->
<form action="groupJoinResult" method="post" style="margin-top: 150px; text-align: center;" onsubmit="return validateForm();">
   <div class="">
   ...
   목차 [<span id="toc-toggle" onclick="openCloseToc()">보이기</span>]
      <ol id="toc-content">
        ...
        <input type="checkbox" id="termsCheckbox" name="terms" value="agree"/> 서비스 제공자의 가입약관과 상기 정보제공에 동의합니다.
      </ol>
   </div>
