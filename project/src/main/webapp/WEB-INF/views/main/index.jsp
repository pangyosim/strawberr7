			...
			<table>
				<tr>
					<c:forEach var="party" items="${party }">
						...
						<c:if test="${party.service =='laftel' }">
							<img
								src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAxODEyMDdfODcg%2FMDAxNTQ0MTU4OTUzNjA5.vI6eWeIGzYswG9-z5WF4XFt3zs5hjQIY7w4myPxtNqEg.O5Ffe5DLDobJys5UF_e72kGaDG1Ehren6hd5q7GTXZUg.PNG.fjdkeivn%2F591268425cd4eba6d8a8f2d8b25b5d18df0132da115dc0d2da96dc9d71c0bf1238e609547a3e.png&type=a340"
								style="width: 200px; height: 200px"
								onclick="location.href='youtubePartyList?seq=${party.seq }'">
							<br>[<c:out value="${party.service}" />]<br>
							<c:out value="${party.peoplecnt}" />명<br>
						...
						<td><c:if test="${party.service =='coupangplay' }">
								<img
									src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMDEyMjVfMjg2%2FMDAxNjA4ODc2NjA2MDAw.KTHw2YzYnrnM2oUxofXZh7-d8KVJLIY7eGhkSw7GPoYg.NhFr8Nyk9UJu5SzMjDoMtvO4ocWaLntOpOYiGzr_o2Mg.PNG.kimellezzang%2F2020-12-25_14_51_40.png&type=a340"
									style="width: 200px; height: 200px"
									onclick="location.href='youtubePartyList?seq=${party.seq }'">
								<br>[<c:out value="${party.service}" />]<br>
								<c:out value="${party.peoplecnt}" />명<br>
						...
						<td>
							<!--  --> <c:if test="${party.service =='tving' }">
								<img
									src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMzExMDdfMjA4%2FMDAxNjk5MzU4ODYzMTUx.STlC5nmU-e3d1NeuwavGYdccpLDOFrqDPPKbxcoCUO8g.DH4wW1_s2Xd1ZkCLZL1QeFc59kTKH9rLvwKp4gn4mlYg.PNG.toreview%2Fimage.png&type=a340"
									style="width: 200px; height: 200px"
									onclick="location.href='youtubePartyList?seq=${party.seq }'">
								<br>[<c:out value="${party.service}" />]<br>
								<c:out value="${party.peoplecnt}" />명<br>
						...
						<td><c:if test="${party.service =='netflix' }">
								<img
									src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMzExMTVfNjcg%2FMDAxNzAwMDM4MDQzOTM0.laU6tnoEZzZ6u1ICzPzmtM3Dlo2HUTzQnJnyd6eEQhMg.LyCcGjy9DyTxUll7GiOW51BcMEGXqSD8BUeNwCpqmgkg.PNG.sistar000%2Fimage.png&type=a340"
									style="width: 200px; height: 200px"
									onclick="location.href='youtubePartyList?seq=${party.seq }'">
								<br>[<c:out value="${party.service}" />]<br>
								<c:out value="${party.peoplecnt}" />명<br>
