	...
	<div class="" style="margin-top: 100px">
		...
		<c:if test="${kakaoid == null }">
			<div>
				<button id="kakao-login-btn">
					<img alt="" src="resources/assets/img/kakaologin.png"
						style="width: 20px; height: 20px;"> 카카오 회원가입 하기
				</button>
			</div>
		...
		<div id="termsModal" class="modal">
			<div class="modal-content">
					...
					<div class="page-content">
						...
						<ol>
							<li>"몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는
								곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자
								등을 이용자가 쉽게 알 수 있도록 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가
						...
						<ol>
							<li>이 약관은 2023년 12월 13일부터 시행합니다.</li>
				...
				<input type="checkbox" id="modalNuber1" style="text-align: center;"> 회원가입 약관의 동의합니다.
				...
				<div class="scrollable-box">
					...
					<div class="page-content">
						...
						<ol>
							<li>본 사이트는 개인정보보호와 관련하여 귀하가 의견과 불만을 제기할 수 있는 창구를 개설하고 있습니다.
								...
								처리결과를 통보해 드립니다.
								<ol>
									<li>개인정보 보호책임자 성명 : 추지성</li>
									<li>이메일 : oy1666919@gmail.com</li>
								</ol>
							</li>
						...
						<ol>
							<li>본 방침은 2023년 12월 13일부터 시행합니다.</li>
						</ol>
					...
					<input type="checkbox" id="modalNuber2"> 개인정보처리방침 안내 내용에 동의합니다.
				<div class="modal-footer" style="text-align: center;">
					<br/>
        			<button id="agreeModal" disabled>동의</button> <!-- 처음에 버튼을 비활성화 상태로 설정합니다. -->
		...
		<form id="memberjoinForm" action="memberJoinResult" method="post">
			...
			<div class="textForm">
				<input type="password" placeholder="비밀번호" id="loginPw"
					name="loginPw" maxlength="20"><br> <input
